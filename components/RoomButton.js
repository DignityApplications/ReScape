...
const RoomButton = ({backgroundColor, roomID, roomName, roomDifficulty, onSelect=f=>f}) => (
<TouchableHighlight onPress={() => onSelect(backgroundColor, roomID)} underlayColor='grey'>
